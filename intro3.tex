...
\paragraph{Gra} W literaturze pojawia się wiele 
...
Następnie w celu wyznaczenia parametrów rozgrywki. 
...
\section{Wnioski}
Przygotowany algorytm najlepiej sobie radzi w rozgrywce dla dwóch graczy. 
...
\begin{enumerate}
	...
	\subitem(Dostęp: ) \\ \url{https://github....}
\end{enumerate}
\end{document}